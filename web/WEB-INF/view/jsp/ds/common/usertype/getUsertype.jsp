...
<div class="line"></div>
<form id="queryForm" method="post" action="getUsertype.htm">
<table border="0" cellspacing="0" cellpadding="0" class="queryTable">
	<tr>
		<td class="input">
			&nbsp;名称：<input type="text" class="text" name="name" value="${fn:escapeXml(param.name)}" />
			&nbsp;标识：<input type="text" class="text" name="alias" value="${fn:escapeXml(param.alias)}" />
		</td>
...
<div class="line"></div>
<form id="listForm" method="post" action="delUsertype.htm">
